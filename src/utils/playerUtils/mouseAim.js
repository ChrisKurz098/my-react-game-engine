export default function mouseAim(gameDim,setPlayer, kbCheck, msCheck, params) {
   ...
   var rect = document.getElementsByClassName('game-window')[0].getBoundingClientRect();
    var xm = msCheck.clientX  - rect.x; //x position within the element.
    var ym = msCheck.clientY - rect.y;  //y position within the element.
        //--jumping--//
        ...
        //console.clear()
        console.log("X: ", (x+(w/2)), "Y: ", (y+(h/2)))
        console.log(rect, 'MouseX: ',xm,"MouseY: ", ym, "RAD: ", rad, "change: ", change.dir)
        return {...old, ...change};
    });
}